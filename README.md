...
Добавлено навигационное меню и реализован неоходимый функционал:
- Добавление нового животного
- Вывод списка животных
- Вывод списка изученных команд для отдельного животного
...
Добавлен класс Counter и соответствующий метод add(), увеличивающий счетчик на 1 при создании нового животного.
